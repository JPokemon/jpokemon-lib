...
public class ClassicNatureManager extends SimpleManager<Nature> {
	...
	public ClassicNatureManager() {
		...
		register(new Nature().setName(ADAMANT_NATURE).setStatIncreased("Attack").setStatDecreased("Special Attack").setFlavorFavorite("Spicy")
				.setFlavorDisliked("Dry"));
		register(new Nature().setName(BRAVE_NATURE).setStatIncreased("Attack").setStatDecreased("Speed").setFlavorFavorite("Spicy").setFlavorDisliked("Sweet"));
		register(new Nature().setName(LONELY_NATURE).setStatIncreased("Attack").setStatDecreased("Defense").setFlavorFavorite("Spicy").setFlavorDisliked("Sour"));
		register(new Nature().setName(NAUGHTY_NATURE).setStatIncreased("Attack").setStatDecreased("Special Defense").setFlavorFavorite("Spicy")
				.setFlavorDisliked("Bitter"));

		// Defense-Increasing, Sour-Loving Natures
		register(new Nature().setName(BOLD_NATURE).setStatIncreased("Defense").setStatDecreased("Attack").setFlavorFavorite("Sour").setFlavorDisliked("Spicy"));
		register(new Nature().setName(RELAXED_NATURE).setStatIncreased("Defense").setStatDecreased("Speed").setFlavorFavorite("Sour").setFlavorDisliked("Sweet"));
		register(new Nature().setName(IMPISH_NATURE).setStatIncreased("Defense").setStatDecreased("Special Attack").setFlavorFavorite("Sour")
				.setFlavorDisliked("Dry"));
		register(new Nature().setName(LAX_NATURE).setStatIncreased("Defense").setStatDecreased("Special Defense").setFlavorFavorite("Sour")
				.setFlavorDisliked("Bitter"));

		// Special Attack-Increasing, Dry-Loving Natures
		register(new Nature().setName(MODEST_NATURE).setStatIncreased("Special Attack").setStatDecreased("Attack").setFlavorFavorite("Dry")
				.setFlavorDisliked("Spicy"));
		register(new Nature().setName(MILD_NATURE).setStatIncreased("Special Attack").setStatDecreased("Defense").setFlavorFavorite("Dry")
				.setFlavorDisliked("Sour"));
		register(new Nature().setName(QUIET_NATURE).setStatIncreased("Special Attack").setStatDecreased("Speed").setFlavorFavorite("Dry")
				.setFlavorDisliked("Sweet"));
		register(new Nature().setName(RASH_NATURE).setStatIncreased("Special Attack").setStatDecreased("Special Defense").setFlavorFavorite("Dry")
				.setFlavorDisliked("Bitter"));

		// Special Defense-Increasing, Bitter-Loving Natures
		register(new Nature().setName(CALM_NATURE).setStatIncreased("Special Defense").setStatDecreased("Attack").setFlavorFavorite("Bitter")
				.setFlavorDisliked("Spicy"));
		register(new Nature().setName(GENTLE_NATURE).setStatIncreased("Special Defense").setStatDecreased("Defense").setFlavorFavorite("Bitter")
				.setFlavorDisliked("Sour"));
		register(new Nature().setName(SASSY_NATURE).setStatIncreased("Special Defense").setStatDecreased("Speed").setFlavorFavorite("Bitter")
				.setFlavorDisliked("Sweet"));
		register(new Nature().setName(CAREFUL_NATURE).setStatIncreased("Special Defense").setStatDecreased("Special Attack").setFlavorFavorite("Bitter")
				.setFlavorDisliked("Dry"));

		// Speed-Increasing, Sweet-Loving Natures
		register(new Nature().setName(TIMID_NATURE).setStatIncreased("Speed").setStatDecreased("Attack").setFlavorFavorite("Sweet").setFlavorDisliked("Spicy"));
		register(new Nature().setName(HASTY_NATURE).setStatIncreased("Speed").setStatDecreased("Defense").setFlavorFavorite("Sweet").setFlavorDisliked("Sour"));
		register(new Nature().setName(JOLLY_NATURE).setStatIncreased("Speed").setStatDecreased("Special Attack").setFlavorFavorite("Sweet")
				.setFlavorDisliked("Dry"));
		register(new Nature().setName(NAIVE_NATURE).setStatIncreased("Speed").setStatDecreased("Special Defense").setFlavorFavorite("Sweet")
				.setFlavorDisliked("Bitter"));
	}
}
